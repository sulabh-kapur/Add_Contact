...
$required_fields = ['first_name' , 'last_name' , 'email' , 'contact' , 'address' , 'image'];
...
$error = [];
 ...
 if(count($error) ==0){
    ...
    $query = "INSERT INTO contact ( `first_name`,`last_name`,`email`, `contact`, `address`,`auth_id`,`image`) VALUES ('$fname','$lname' ,'$email' , '$contact' , '$address',$author_id ,'$unique_img_name' )";
